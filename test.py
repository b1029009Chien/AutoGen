...
async def main():
    ...
    question_generator = AssistantAgent(
        ...
        model_client=ollama_client,
        system_message="You are a question generation expert skilled at creating targeted course questions based on self-organized notes and distilled key points."
    )
